...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
           ...
           {
                echo "<a href='giris.php' class='btn btn-primary my-2'>Giriş</a>";
           }
            else
            {
        ...
        <div class="col-md-4">
            <form action="kullanici_kaydet.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" required="" class="form-control" name="kullanici_adi" placeholder="Kullanıcı adınızı yazın..">
                </div>
                <div class="form-group">
                    <label for="email">E-posta Adresiniz</label>
                    <input type="email" required="" class="form-control" name="mail" placeholder="E-posta adresinizi yazın..">
                </div>
                <div class="form-group">
                    <label for="password">Şifreniz</label>
                    <input type="password" required="" class="form-control" name="parola" placeholder="*******">
                </div>
                <div class="form-group">
                    <label for="password-again">Şifreniz (Tekrar)</label>
                    <input type="password" required="" class="form-control" name="parola_tekrar" placeholder="*******">
                </div>
