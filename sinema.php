...
<section class="jumbotron text-center">
    <div class="container">
        ...
        <?php
                    ...
                    $onayli_icerik = mysqli_query($baglanti, "select haber_baslik,kategori,tarih,haber_icerik, haber_id,resim from icerik where onay ='1' and kategori='Sinema'order by tarih desc");
